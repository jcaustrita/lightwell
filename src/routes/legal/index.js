			...
			<>
				...
				<Grid block stacked>
					<Cell
						headline="Shipping"
						body={
							<p>Lightwell Survey orders ship once to twice a year upon release dates set by each vintage. All orders will ship via Lightwell Survey's chosen courier. Once shipped, you will receive a confirmation email outlining the details of your delicious order. Please contact Lightwell Survey if you have any questions about your order: <MailToLink /></p>
						}
					/>
					<Cell
						headline="Returns"
					...
					<Cell
						...
						body={
							<>
								<p>In using lightwellsurvey.com you are agreeing to the terms and conditions that are beautifully displayed on this page. No take backs. Please review these terms and conditions. Entering lightwellsurvey.com constitutes your agreement to follow and abide by these terms and conditions. If you choose to deny these terms and conditions please do not use lightwellsurvey.com and visit another website. Lightwell Survey reserves the rights to update and change the terms and conditions at any time... cuz we can do that, they're OUR terms and conditions. So, please review the terms and conditions after each visit to the site.</p>
								<p>All content on lightwellsurvey.com is the sole property of Lightwell Survey Wines. All photos, graphics, and copy are protected by the international copyright and intellectual property laws. You may not copy, transfer, reproduce, retransmit, modify, borrow, or sell any portion of this site without the express written permission of Lightwell Survey Wines.</p>
								<p>You agree to not hold Lightwell Survey harmless from and against all losses, claims, damages, expenses and costs, including attorneys’ fees resulting from any violation of these terms and conditions related to you.</p>
